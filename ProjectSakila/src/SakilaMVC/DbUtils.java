 ...
 * 				convert a Results set object passed in from a query into a
 ...
 *         NOTE: Special thanks to Lynn Koudsi of Section 02 for suggesting the change to a Vecotro of vectors fothe 
...
public class DbUtils
{
	 ...
	 */
     ...
     {
         try {
        	 //gety the metadata for number of columns and column names
